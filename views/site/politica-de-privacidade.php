...
?>
<div class="site-politica-de-privacidade">
    
    <h1><?= Html::encode($this->title) ?></h1>
    
    <p>
        <span style="color: rgb(68, 68, 68);">
            A sua privacidade é importante para nós. É política do Dimensionamento Solar Off Grid respeitar 
            a sua privacidade em relação a qualquer informação sua que possamos coletar no site 
            <a href="dimensionamento.projetosolar.online">
    ...
    <p>
        ...
        <a href="https://politicaprivacidade.com/" rel="noopener noreferrer" target="_blank" style="background-color: transparent; color: rgb(68, 68, 68);">
            ...
            <ul>
                ...
                <li>
                    <span style="color: rgb(68, 68, 68);">
                        ...
                        nos permitem ver se nossos clientes acessaram o site através de um dos sites de nossos parceiros, 
                        para que possamos creditá-los adequadamente e, quando aplicável, permitir que nossos parceiros 
                        afiliados ofereçam qualquer promoção que pode fornecê-lo para fazer uma compra.
                    </span>
                </li>
            </ul>
        </span>
    ...
    <p>
        <span style="color: rgb(68, 68, 68);">
            O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Dimensionamento Solar 
            Off Grid oferece no site e com caráter enunciativo, mas não limitativo:
        </span>
    </p>
    <ul>
        <li>
        ...
        <li>
            ...
            <span style="color: rgb(33, 37, 41);">
                <a href='https://166bet.br.com' style='color:inherit !important; text-decoration: none !important; font-size: inherit !important;'>
                    166bet
                </a>
            </span>
            <span style="color: rgb(68, 68, 68);"> 
        ...
        <li>
            <span style="color: rgb(68, 68, 68);">
                C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Dimensionamento Solar Off 
                Grid, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer 
    ...
    <p>
        <span style="color: rgb(68, 68, 68);">
            Esta política é efetiva a partir de&nbsp;1 April 2025 18:50
        </span>
    </p>
