...
$this->params['breadcrumbs'][] = ['label' => 'Links'];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="site-termos-de-uso">
    ...
    <p>
        <span style="color: rgb(68, 68, 68);">
            Ao acessar ao site 
            <a href="https://dimensionamento.projetosolar.online">
    ...
    <p>
        <span style="color: rgb(68, 68, 68);">
            ...
            (informações ou software) no site Dimensionamento Solar Off Grid , apenas 
            para visualização transitória pessoal e não comercial. Esta é a concessão 
            de uma licença, não uma transferência de título e, sob esta licença, você 
            não pode:&nbsp;
        </span>
    </p>
    ...
    <ol>
        ...
        <li>
            <span style="color: rgb(68, 68, 68);">
                tentar descompilar ou fazer engenharia reversa de qualquer software contido 
                no site Dimensionamento Solar Off Grid;&nbsp;
            </span>
        </li>
        <li>
            <span style="color: rgb(68, 68, 68);">
    ...
    <p>
        <span style="color: rgb(68, 68, 68);">
            ...
            restrições e poderá ser rescindida por Dimensionamento Solar Off Grid a 
    ...
    <ol>
        <li>
            <span style="color: rgb(68, 68, 68);">
                Os materiais no site da Dimensionamento Solar Off Grid são fornecidos 
                'como estão'. Dimensionamento Solar Off Grid não oferece garantias, 
        ...
        <li>
            <span style="color: rgb(68, 68, 68);">
                Além disso, o Dimensionamento Solar Off Grid não garante ou faz qualquer 
    ...
    <p>
        <span style="color: rgb(68, 68, 68);">
            Em nenhum caso o Dimensionamento Solar Off Grid ou seus fornecedores 
            ...
            decorrentes do uso ou da incapacidade de usar os materiais em Dimensionamento
            Solar Off Grid, mesmo que Dimensionamento Solar Off Grid ou um 
            representante autorizado da Dimensionamento Solar Off Grid tenha sido 
    ...
    <p>
        <span style="color: rgb(68, 68, 68);">
            Os materiais exibidos no site da Dimensionamento Solar Off Grid 
            podem incluir erros técnicos, tipográficos ou fotográficos. 
            Dimensionamento Solar Off Grid não garante que qualquer material 
            em seu site seja preciso, completo ou atual. Dimensionamento
            Solar Off Grid pode fazer alterações nos materiais contidos em seu site 
            a qualquer momento, sem aviso prévio. No entanto, Dimensionamento Solar Off Grid
    ...
    <p>
        <span style="color: rgb(68, 68, 68);">
            O Dimensionamento Solar Off Grid não analisou todos os sites vinculados 
            ao seu site e não é responsável pelo conteúdo de nenhum site vinculado. 
            A inclusão de qualquer link não implica endosso por Dimensionamento Solar Off Grid do site. 
    ...
    <p>
        <span style="color: rgb(68, 68, 68);">
            O Dimensionamento Solar Off Grid pode revisar estes termos de serviço do 
            site a qualquer momento, sem aviso prévio. Ao usar este site, você concorda 
    ...
    <p>
        <span style="color: rgb(68, 68, 68);">
            ...
            do Dimensionamento Solar Off Grid e você se submete irrevogavelmente à 
